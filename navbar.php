...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<?php  if( $_SESSION['login_type'] == 3 || $_SESSION['login_type'] == 4 ||$_SESSION['login_type'] == 6){?>
				<a href="index.php?page=mteam1" class="nav-item nav-persons"><span class='icon-field'><i class="fa fa-user-friends"></i></span>M Team</a>
				<?php }?>
				<!-- <?php  if($_SESSION['login_type'] == 6){?>
				<a href="index.php?page=mteam1" class="nav-item nav-persons"><span class='icon-field'><i class="fa fa-user-friends"></i></span> M Team</a>
				<?php }?> -->
				<?php  if($_SESSION['login_type'] == 7){?>
				<a href="index.php?page=mteam2" class="nav-item nav-persons"><span class='icon-field'><i class="fa fa-user-friends"></i></span> M Team</a>
				<?php }?>
				<?php  if($_SESSION['login_type'] == 8){?>
				<a href="index.php?page=mteam3" class="nav-item nav-persons"><span class='icon-field'><i class="fa fa-user-friends"></i></span> M Team</a>
				<?php }?>
				<?php  if($_SESSION['login_type'] == 9){?>
				<a href="index.php?page=mteam4" class="nav-item nav-persons"><span class='icon-field'><i class="fa fa-user-friends"></i></span> M Team</a>
				<?php }?>
				<?php  if($_SESSION['login_type'] == 10){?>
				<a href="index.php?page=mteam5" class="nav-item nav-persons"><span class='icon-field'><i class="fa fa-user-friends"></i></span> M Team</a>
				<?php }?>
